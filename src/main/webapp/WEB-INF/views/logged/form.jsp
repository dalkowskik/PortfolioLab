...
<section class="form--steps">
    ...
    <div class="form--steps-container">
        ...
        <form:form  modelAttribute="dotation" method="post" >
            ...
            <div data-step="1" class="active">
                ...
                <div class="form-group form-group--checkbox">
                    <label>
                        ...
                        <input type="checkbox" id="categories2" name="category" value="${c.id}" categoryName="${c.name}" />
            ...
            <div data-step="2">
                ...
                <div class="form-group form-group--inline">
                    <label>
                        Liczba 60l worków:
                        <form:input path="quantity" id="allbags" type="number" name="bags" step="1" min="1" />
                    </label>
                </div>
            ...
            <div data-step="3">
                ...
                <c:forEach items="${instuties}" var="i" varStatus="loop">

                <div class="form-group form-group--checkbox">
                    <label>
<%--                        pobierz parametr i.name do javascript getAtriubiote--%>
                        <input type="radio" name="institution" class="institiutionsEndForm" value="${i.id}" institutionName="${i.name}" />
                ...
                <div class="form-section form-section--columns">
                    ...
                    <div class="form-section--column">
                        ...
                        <div class="form-group form-group--inline">
                            <label>
                                Uwagi dla kuriera
                                <form:textarea path="pickUpComment" name="more_info" rows="5" id="comment"></form:textarea>
                            </label>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-section">
                        ...
                        <ul>
                            <li>
                                ...
                                <span class="summary--text" id="worksEnd"></span>
                            </li>

                            <li>
                                <span class="icon icon-hand"></span>
                                <span class="summary--text" id="intitutionEnd"></span>
                            </li>
                        </ul>
                    </div>
